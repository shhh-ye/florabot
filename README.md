...
4. Если настроена Google Таблица, её строки тоже попадают в индекс, а для
   точных актуальных данных (наличие, цена) модель дополнительно может
   выполнить живой поиск по таблице.
