...
# 30с: клиент получает хоть какой-то ответ быстро. Обратная сторона —
# честно медленная генерация (модель + таблица + вторая модель) может
# не успеть, и клиент получит извинение вместо готового ответа; если
# такое зачастит, поднимите REPLY_DEADLINE в окружении до 45-60.
REPLY_DEADLINE = float(os.environ.get("REPLY_DEADLINE", "30"))
